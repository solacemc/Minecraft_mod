...
public class Block
{
    ...
    public static final Block blockJump = (new BlockJump(251, Material.rock)).setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("blockJump").func_111022_d("blockJump");
